...
#     player_pips = 0
#     opponent_pips = 0
#     mobility = len(game.actions(state))  #  ora corretto
...
#     cell_score = player_cells - opponent_cells
#     pip_score = player_pips - opponent_pips

#     return 3 * cell_score + pip_score + 0.1 * mobility
